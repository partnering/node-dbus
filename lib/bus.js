...
//*/
    ...
    /*
        Make the bus object listen for 'NamedOwnerChanged' evetn, and provide a high-level, Javascript event for it.
    ...
    */
    ...
    this.addMatch(namedOwnerChangedRule, (err, _) => {
        ...
        if (err != null) {
            ...
            const mangledOwnerChanged = this.bus.mangle('/org/freedesktop/DBus', 'org.freedesktop.DBus', 'NameOwnerChanged')

            this.signals.on(mangledOwnerChanged, (...args) => {
